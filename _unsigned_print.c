...
*/
int _octal(va_list arg_list, char output_buffer[], int format_flags, int field_width, int precision_val, int length_mod)
{
...
if (format_flags & F_HASH && int_nmu != 0)
	output_buffer[buffer_index--] = '0';
buffer_index++;
return (write_ungnd(0, buffer_index, output_buffer, format_flags, field_width, precision_val, length_mod));
}
